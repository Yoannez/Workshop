...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.io_apb_PADDR );
      signalAccess[1] = new CDataSignalAccess( top.io_apb_PSEL );
      signalAccess[2] = new CDataSignalAccess( top.io_apb_PENABLE );
      signalAccess[3] = new CDataSignalAccess( top.io_apb_PWRITE );
      signalAccess[4] = new IDataSignalAccess( top.io_apb_PWDATA );
      signalAccess[5] = new CDataSignalAccess( top.io_apb_PREADY );
      signalAccess[6] = new IDataSignalAccess( top.io_apb_PRDATA );
      signalAccess[7] = new CDataSignalAccess( top.io_apb_PSLVERROR );
      signalAccess[8] = new CDataSignalAccess( top.io_fullA );
      signalAccess[9] = new CDataSignalAccess( top.io_fullB );
      signalAccess[10] = new CDataSignalAccess( top.io_external_tick );
      signalAccess[11] = new CDataSignalAccess( top.io_external_clear );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/qichao/SpinalWorkshop/waves/Apb3Timer/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/qichao/SpinalWorkshop/waves/Apb3Timer/") + name + ".dat").c_str());
      #endif
    }
