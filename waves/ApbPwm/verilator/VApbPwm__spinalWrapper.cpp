...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[3] = new IDataSignalAccess( top.io_apb_PWDATA );
      signalAccess[4] = new CDataSignalAccess( top.io_apb_PWRITE );
      signalAccess[5] = new IDataSignalAccess( top.io_apb_PRDATA );
      signalAccess[6] = new CDataSignalAccess( top.io_apb_PREADY );
      signalAccess[7] = new CDataSignalAccess( top.io_pwm );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/qichao/SpinalWorkshop/waves/ApbPwm/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/qichao/SpinalWorkshop/waves/ApbPwm/") + name + ".dat").c_str());
      #endif
    }
