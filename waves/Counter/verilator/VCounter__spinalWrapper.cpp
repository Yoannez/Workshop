...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.io_clear );
      signalAccess[1] = new CDataSignalAccess( top.io_value );
      signalAccess[2] = new CDataSignalAccess( top.io_full );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/qichao/SpinalWorkshop/waves/Counter/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/qichao/SpinalWorkshop/waves/Counter/") + name + ".dat").c_str());
      #endif
    }
