...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.io_tick );
      signalAccess[1] = new CDataSignalAccess( top.io_clear );
      signalAccess[2] = new CDataSignalAccess( top.io_limit );
      signalAccess[3] = new CDataSignalAccess( top.io_full );
      signalAccess[4] = new CDataSignalAccess( top.io_value );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/qichao/SpinalWorkshop/waves/Timer/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/qichao/SpinalWorkshop/waves/Timer/") + name + ".dat").c_str());
      #endif
    }
