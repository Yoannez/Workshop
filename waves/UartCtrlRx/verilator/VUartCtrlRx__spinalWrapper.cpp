...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new CDataSignalAccess( top.io_rxd );
      signalAccess[1] = new CDataSignalAccess( top.io_samplingTick );
      signalAccess[2] = new CDataSignalAccess( top.io_read_valid );
      signalAccess[3] = new CDataSignalAccess( top.io_read_payload );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/qichao/SpinalWorkshop/waves/UartCtrlRx/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/qichao/SpinalWorkshop/waves/UartCtrlRx/") + name + ".dat").c_str());
      #endif
    }
