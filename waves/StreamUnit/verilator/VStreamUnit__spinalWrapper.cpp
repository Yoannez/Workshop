...
public:
    ...
    Wrapper_1(const char * name){
      ...
      waveEnabled = true;
      signalAccess[0] = new IDataSignalAccess( top.StreamUnit->mem[0] );
      signalAccess[1] = new CDataSignalAccess( top.io_memWrite_valid );
      signalAccess[2] = new CDataSignalAccess( top.io_memWrite_payload_address );
      signalAccess[3] = new IDataSignalAccess( top.io_memWrite_payload_data );
      signalAccess[4] = new CDataSignalAccess( top.io_cmdA_valid );
      signalAccess[5] = new CDataSignalAccess( top.io_cmdA_ready );
      signalAccess[6] = new CDataSignalAccess( top.io_cmdA_payload );
      signalAccess[7] = new CDataSignalAccess( top.io_cmdB_valid );
      signalAccess[8] = new CDataSignalAccess( top.io_cmdB_ready );
      signalAccess[9] = new IDataSignalAccess( top.io_cmdB_payload );
      signalAccess[10] = new CDataSignalAccess( top.io_rsp_valid );
      signalAccess[11] = new CDataSignalAccess( top.io_rsp_ready );
      signalAccess[12] = new IDataSignalAccess( top.io_rsp_payload );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/qichao/SpinalWorkshop/waves/StreamUnit/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/qichao/SpinalWorkshop/waves/StreamUnit/") + name + ".dat").c_str());
      #endif
    }
