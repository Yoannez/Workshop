...
public:
    ...
    Wrapper_1(const char * name){
      ...
      signalAccess[1] = new CDataSignalAccess( top.io_cmd_payload );
      signalAccess[2] = new CDataSignalAccess( top.io_valueA );
      signalAccess[3] = new IDataSignalAccess( top.io_valueB );
      signalAccess[4] = new QDataSignalAccess( top.io_valueC );
      ...
      top.trace(&tfp, 99);
      tfp.open((std::string("/home/qichao/SpinalWorkshop/waves/FunctionUnit/") + name + ".vcd").c_str());
      #endif
      this->name = name;
    }
    ...
    virtual ~Wrapper_1(){
      ...
      #endif
      #ifdef COVERAGE
      VerilatedCov::write((("/home/qichao/SpinalWorkshop/waves/FunctionUnit/") + name + ".dat").c_str());
      #endif
    }
